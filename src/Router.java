...
public class Router implements IRouter {
        ...
        public boolean routeAdd(int destinationNetwork, byte prefix, int gateway,
                ...
                if (test.containsKey(id)) {
                        System.err.println("Failed to add route: Route " + intIPtoString(destinationNetwork) + " already in use!");
                        return false;
                }
        ...
        public boolean routeDelete(int destinationNetwork) {
                ...
                System.err.println("Failed to delete route! Route with the destination " + intIPtoString(destinationNetwork)+" does not exist");        
                return false;
        }
        ...
        public boolean routeModify(int destinationNetwork, byte prefix,
                ...
                if (!test.containsKey(id)) {
                        System.err.println("Failed to modify route: Route " + intIPtoString(destinationNetwork) + " not in use!");
                        return false;
                }
        ...
        public HWPort findRoute(int destination) {
                ...
                System.err.println("Failed to find Route ! " + intIPtoString(destination) + " does not exist !");
